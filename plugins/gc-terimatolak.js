...
let handler = async (m, { conn, args }) => {
  ...
  switch (subCommand) {
    ...
    default:
      reply("Perintah tidak valid. Gunakan *acc list*, *member approve [number]*, *member reject [number]*, *member reject [JID]*, *member reject/approve all* untuk menolak/menyetujui semua permintaan bergabung.");
  }
}

handler.help = ['member approve/reject']
handler.tags = ['group']
